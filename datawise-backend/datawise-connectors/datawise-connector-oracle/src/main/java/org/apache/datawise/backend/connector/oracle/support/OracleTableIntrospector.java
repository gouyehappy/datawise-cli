package org.apache.datawise.backend.connector.oracle.support;
...
/** Oracle table/view metadata via data dictionary views and DBMS_METADATA. */
public class OracleTableIntrospector implements TableMetadataIntrospection {
    ...
    private static String owner(String database) {
        if (database == null || database.isBlank()) {
            throw new IllegalArgumentException("Oracle schema owner is required");
        }
    ...
    private static String formatOracleDataType(
            String dataType,
            Object dataLength,
            Object precision,
            Object scale
