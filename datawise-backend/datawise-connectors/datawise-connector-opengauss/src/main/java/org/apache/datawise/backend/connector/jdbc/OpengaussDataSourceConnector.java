...
public class OpengaussDataSourceConnector extends AbstractJdbcDataSourceConnector {

    private final PostgresqlConnectorOperations postgresql;

    public OpengaussDataSourceConnector(ConnectorJdbcOperations jdbc, PostgresqlConnectorOperations postgresql) {
        super("jdbc-opengauss", 21, Set.of("opengauss"), jdbc);
