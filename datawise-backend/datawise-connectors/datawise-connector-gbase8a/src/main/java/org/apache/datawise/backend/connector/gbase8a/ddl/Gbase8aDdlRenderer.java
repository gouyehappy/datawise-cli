package org.apache.datawise.backend.connector.gbase8a.ddl;
...
/** GBase 8a DDL rendering (MySQL-compatible syntax). */
public final class Gbase8aDdlRenderer implements DialectDdlRenderer {
