package org.apache.datawise.backend.connector.dm.support;
...
/** Dameng table/view metadata via data dictionary views (Oracle-compatible). */
public class DmTableIntrospector implements TableMetadataIntrospection {
    ...
    private static String owner(String database) {
        if (database == null || database.isBlank()) {
            throw new IllegalArgumentException("Dameng schema owner is required");
        }
