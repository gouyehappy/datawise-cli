package org.apache.datawise.backend.connector.oscar.schema;
...
/** Oscar schema dialect: explorer database nodes map to owner/schema names. */
public final class OscarSchemaDialect implements SchemaDialect {
