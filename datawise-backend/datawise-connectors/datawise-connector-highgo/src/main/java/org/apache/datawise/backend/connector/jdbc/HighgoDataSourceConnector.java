...
public class HighgoDataSourceConnector extends AbstractJdbcDataSourceConnector {

    private final PostgresqlConnectorOperations postgresql;

    public HighgoDataSourceConnector(ConnectorJdbcOperations jdbc, PostgresqlConnectorOperations postgresql) {
        super("jdbc-highgo", 21, Set.of("highgo"), jdbc);
