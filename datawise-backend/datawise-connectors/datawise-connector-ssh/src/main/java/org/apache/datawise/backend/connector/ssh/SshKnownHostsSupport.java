...
final class SshKnownHostsSupport {
    ...
    static void configureKnownHosts(JSch jsch, SshClientProperties properties) throws JSchException {
    ...
    static void persistKnownHosts(JSch jsch, SshClientProperties properties) {
    ...
    static String strictHostKeyCheckingMode(SshClientProperties properties) {
        if (!properties.isStrictHostKeyChecking()) {
            return "no";
        }
    ...
    private static Path resolveKnownHostsPath(SshClientProperties properties) {
