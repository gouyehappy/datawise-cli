...
public class ExpressionAnalysis
{
            ...
            Set<NodeRef<FunctionCall>> windowFunctions)
    {
        ...
        this.expressionCoercions = ImmutableMap.copyOf(requireNonNull(
                expressionCoercions,
        ...
        this.subqueryInPredicates = ImmutableSet.copyOf(requireNonNull(
                subqueryInPredicates,
                "subqueryInPredicates is null"));
        ...
        this.quantifiedComparisons = ImmutableSet.copyOf(requireNonNull(
