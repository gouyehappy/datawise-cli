...
import static org.apache.datawise.sqlflow.tree.window.SkipTo.Position.FIRST;
import static org.apache.datawise.sqlflow.tree.window.SkipTo.Position.LAST;
import static org.apache.datawise.sqlflow.tree.window.SkipTo.Position.NEXT;
import static org.apache.datawise.sqlflow.tree.window.SkipTo.Position.PAST_LAST;

/**
 * huaixin 2021/12/19 9:51 PM
 */
public class SkipTo extends Node
{
    ...
    private SkipTo(Optional<NodeLocation> location, Position position, Optional<Identifier> identifier)
    {
        ...
        checkArgument(
                ...
                "missing identifier in SKIP TO " + position.name());
        checkArgument(
                !identifier.isPresent() || (position == FIRST || position == LAST),
                "unexpected identifier in SKIP TO " + position.name());
