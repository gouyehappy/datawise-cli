...
/**
 * sync Service 经 {@link org.apache.datawise.backend.connector.facade.ConnectorFacade} 访问连接器能力。
 */
@AnalyzeClasses(
        packages = "org.apache.datawise.backend.sync",
        importOptions = ImportOption.DoNotIncludeTests.class
)
class SyncServiceArchitectureTest {
