...
```json
{
  ...
  "baseUrl": "https://github.com/org/datawise-cli/releases/download/v1.3.0/",
  "connectors": [
    {
      "id": "mysql",
      "label": "MySQL / MariaDB",
      "tier": "core",
      "primary": true,
      "jar": "datawise-connector-mysql-1.3.0.jar",
      "version": "1.3.0",
      "downloadUrl": "https://.../datawise-connector-mysql-1.3.0.jar",
      "sha256": "hex...",
      "sizeBytes": 2457600,
      "jdbcDriver": {
