import {toPlainCommandText} from '@/features/ssh/services/ssh-script-record-content.service'
...
export function parseMyCommandGroups(
    ...
    for (const record of records) {
        const parsed = parseCommandEntries(toPlainCommandText(record.contentHtml ?? ''))
