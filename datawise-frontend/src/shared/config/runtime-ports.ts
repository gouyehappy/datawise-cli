...
/** 开发 / 手动启动的后端（mvn、Vite 代理） */
export const BACKEND_DEV_PORT = ports.backend
/** Electron 安装包内嵌后端，与开发端口分离以便同机并行 */
export const BACKEND_PACKAGED_PORT = ports.backendPackaged
